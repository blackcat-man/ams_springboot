...
public class SwaggerAddtion implements ApiListingScannerPlugin {
    ...
    public List<ApiDescription> apply(DocumentationContext context) {
        ...
        /**
         * String groupName, String path, String summary, String description, List<Operation> operations, Boolean hidden
         */
        ApiDescription loginApiDescription =
                new ApiDescription("all","/login","登录接口","登录后返回token",Arrays.asList(usernamePasswordOperation),false);
